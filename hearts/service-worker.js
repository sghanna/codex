'use strict';
const CACHE = 'codex-hearts-v12';
const FILES = ['./','./index.html','./style.css','./screens.css','./game.css','./deck.js','./engine.js','./insights.js','./i18n.js','./app.js','./manifest.json','./icons/icon.svg','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
